...
class BookingTest {
    @Test
    void talkback() {
        Show noTaokbackShow = new Show(List.of(), 120);
        ...
        assertFalse(Booking.createBooking(noTaokbackShow, nonPeekday).hasTalkback());
        ...
        assertFalse(Booking.createPremiumBooking(noTaokbackShow, peekDay, premiumExtra).hasTalkback());
    }
